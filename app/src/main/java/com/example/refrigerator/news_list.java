...
public class news_list extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){ // 리스트뷰를 누르면
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                Intent intent=new Intent(news_list.this, news_list_viewer.class);
    ...
    public boolean onContextItemSelected(MenuItem item) { // 컨텍스트메뉴의 버튼을 무엇을 누르냐에 이벤트 정의
        switch(item.getItemId()) { // 누른곳의 Id를 가져옴
            ...
            case DELETE: // 컨텍스트 메뉴 삭제를 클릭시
                ...
                Toast.makeText(news_list.this, delete.getName() + " 이(가) 삭제되었습니다.", Toast.LENGTH_SHORT).show(); // 토스트메세지 띄움
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Toast.makeText(news_list.this, "목록 전체가 삭제되었습니다.", Toast.LENGTH_SHORT).show(); // 토스트메세지
