...
public class Activity3 extends Activity {
        	  ...
        	  case DELETE: // 컨텍스트 메뉴 삭제를 클릭시
            	  ...
            	  index = menuInfoo.position; // 현재 클릭한 DB의 Index값를 가져옴
        		   List delete = mlist.get(index); // 리스트뷰에서 누른곳의 데이터를 delete에 저장
			        Toast.makeText(Activity3.this, delete.getName() + " 이(가) 삭제되었습니다.", Toast.LENGTH_SHORT).show(); // 토스트메세지 띄움
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	Toast.makeText(Activity3.this, "목록 전체가 삭제되었습니다.", Toast.LENGTH_SHORT).show(); // 토스트메세지
